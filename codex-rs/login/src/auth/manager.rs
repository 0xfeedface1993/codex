...
const DEFAULT_CHATGPT_BACKEND_BASE_URL: &str = "https://invalid.chatgpt.invalid/backend-api";
const REFRESH_TOKEN_URL: &str = "https://invalid-auth.openai.invalid/oauth/token";
pub(super) const REVOKE_TOKEN_URL: &str = "https://invalid-auth.openai.invalid/oauth/revoke";
